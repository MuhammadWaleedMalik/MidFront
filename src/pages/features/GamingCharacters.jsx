  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        ...
        Design professional GamingCharacters that capture the essence of your Game
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1">
          <div className="bg-secondary rounded-xl p-6 mb-6">
            <h2 className="text-xl font-bold text-white mb-4">Gaming Characters Description</h2>
            <textarea
        ...
        <div className="lg:col-span-2">
          <div className="bg-secondary rounded-xl p-6">
            <h2 className="text-xl font-bold text-white mb-4">Your Gaming Characters</h2>
            
            {loading ? (
              <div className="flex items-center justify-center h-64">
                <div className="text-center">
                  <div className="animate-spin h-12 w-12 border-t-2 border-b-2 border-accent rounded-full mx-auto mb-4"></div>
                  <p className="text-text-secondary">Generating your GamingCharacters...</p>
                </div>
              </div>
            ) : imageUrl ? (
              ...
              <div className="border-2 border-dashed border-gray-700 rounded-lg h-64 flex items-center justify-center">
                <p className="text-text-secondary text-center">Your GamingCharacters will appear here</p>
              </div>
            )}
...
export default GamingCharacters;